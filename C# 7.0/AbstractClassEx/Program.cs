...
{
    // 추상 클래스 : 인터페이스와 비슷하지만, 추상클래스는 구현(몸통)부를 가질 수 있다.
    //               인스턴스를 가질 수는 없다.

    // 추상클래스는 구현을 갖을 수 있지만 인스턴스를 만들 수 없다.
    ...
    /*
        ...
        - 추상 메소드는 private 이 될 수 없기 때문에 C# 컴파일러는 
          public, protected, internal, protected internal 중에 하나로 수식되도록 하고 있다.
     */
