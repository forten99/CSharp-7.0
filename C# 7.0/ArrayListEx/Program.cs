...
namespace ArrayListEx
{
    /*
        ...
        System.Array는 ICollection 인터페이스를 상속받기 때문에
        배열은 컬렉션의 일부이다.
        ...
        (C#에서 제공하는 모든 컬렉션은 모든 타입의 변수를 담을 수 있다. 
         그 이유는 컬렉션의 요소들은 object 타입으로 지정되기 때문)
     */
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            arrayList.RemoveAt(1);  // == arrayList.Remove(2) 인덱스와 값의 차이
